      ...
      <View style={styles.content}>
        ...
        <View style={styles.centerSection}>
          <View style={styles.illustrationCard}>
            ...
            {/* White border with shadow overlay */}
            <View style={styles.cardBorder} pointerEvents="none" />
          </View>

          {/* Title */}
          <Text style={styles.title}>Đặt lịch thu gom dễ dàng</Text>

          {/* Description */}
          <Text style={styles.description}>
            Chủ động hẹn giờ thu gom phù hợp.{"\n"}
        ...
        <View style={styles.bottomSection}>
          ...
          <TouchableOpacity
            style={styles.button}
            onPress={() => router.push("/Onboarding2Screen")}
          >
